...
public class ReadModel {
     ...
     * @return
     */
    public static boolean JspToHtmlFile(String title,String content,String time,String img, String filePath, String HtmlFile) {
        String str = "";
    ...
    public static void main(String[] arg) {
        ...
        for (int k = 0; k < 10; k++) {
            ...
            String url = "C:\\demo\\src\\main\\resources\\static\\model.html";//模板文件地址
            String savepath = "E:/" + k + ".html";//生成文件地址
